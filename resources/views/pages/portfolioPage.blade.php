...
<title>Aicsa - Multipurpose HTML Template</title>
...
<div class="wrapper-boxed">
  <div class="site-wrapper">
                    ...
                    <ul class="nav navbar-nav">
                      <li class="right active"> <a href="index.html">Home</a> <span class="arrow"></span>
                        <ul class="dm-align-2">
                          ...
                          <li class="active"> <a href="index5.html">Home Page 5</a></li>
                      ...
                      <li> <a href="page-about1.html">Pages</a> <span class="arrow"></span>
                        <ul class="dm-align-2">
          ...
          <div id="rev_slider" class="rev_slider"  data-version="5.0">
            <ul>
              ...
              <li data-index="rs-1" data-transition="fade"> 
                ...
                <!-- MAIN IMAGE --> 
                <img src="images/sliders/7.jpg" alt=""  width="1920" height="1280"> 
			...
			style="z-index: 7; white-space: nowrap;">onsectetuer elit sit amet justo </div>
			...
			data-splitout="none" 
			data-responsive_offset="on" 						
			style="z-index: 7; white-space: nowrap;">Multipage </div>
			...
			data-splitout="none" 
			data-responsive_offset="on" 						
			style="z-index: 7; white-space: nowrap;">Creative Layouts </div>
			...
			data-splitout="none" 
			data-responsive_offset="on" 						
			style="z-index: 7; white-space: nowrap;">Clean & Beautiful </div>
			...
			data-splitout="none" 
			data-responsive_offset="on" 						
			style="z-index: 7; white-space: nowrap;">Designs & PSD's </div>
			...
			style="z-index: 6"> <a href="#">Get Started now!</a> </div>
              ...
              <li data-index="rs-3" data-transition="slideleft"> 
                ...
                <!-- MAIN IMAGE --> 
                <img src="images/sliders/1.jpg" alt=""  width="1920" height="1280"> 
			...
			data-splitout="none" 
			data-responsive_offset="on" 						
			style="z-index: 7; white-space: nowrap;">Layered PSd </div>
			...
			data-splitout="none" 
			data-responsive_offset="on" 						
			style="z-index: 7; white-space: nowrap;">Files and features </div>
        ...
        <div class="row">
          <div class="col-md-4 col-xs-12">
            <div class="ce-feature-box-23">
              <div class="iconbox-tiny round white left icon"><span class="icon-laptop"></span></div>
              <div class="text-box-right less-padding-1">
                <h4 class="font-weight-6 text-white less-mar-1">Website <span class="gfs-didot">Development</span></h4>
                <h6 class="text-white">Consectetuer adipiscing elit.</h6>
              </div>
            </div>
          </div>
          <!--end item-->
          ...
          <div class="col-md-4 col-xs-12">
            <div class="ce-feature-box-23">
              <div class="iconbox-tiny round white left icon"><span class="icon-lightbulb"></span></div>
              <div class="text-box-right less-padding-1">
                <h4 class="font-weight-6 text-white less-mar-1">Unlimited <span class="gfs-didot">Features</span></h4>
                <h6 class="text-white">Consectetuer adipiscing elit.</h6>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4 col-xs-12">
            <div class="ce-feature-box-23">
              <div class="iconbox-tiny round white left icon"><span class="icon-layers"></span></div>
              <div class="text-box-right less-padding-1">
                <h4 class="font-weight-6 text-white less-mar-1">Layered <span class="gfs-didot">PSD Files</span></h4>
                <h6 class="text-white">Consectetuer adipiscing elit.</h6>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4 col-xs-12">
            <div class="ce-feature-box-23">
              <div class="iconbox-tiny round white left icon"><span class="icon-camera"></span></div>
              <div class="text-box-right less-padding-1">
                <h4 class="font-weight-6 text-white less-mar-1">Graphic <span class="gfs-didot">Design</span></h4>
                <h6 class="text-white">Consectetuer adipiscing elit.</h6>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4 col-xs-12">
            <div class="ce-feature-box-23">
              <div class="iconbox-tiny round white left icon"><span class="icon-hotairballoon"></span></div>
              <div class="text-box-right less-padding-1">
                <h4 class="font-weight-6 text-white less-mar-1">Branding <span class="gfs-didot">Agency</span></h4>
                <h6 class="text-white">Consectetuer adipiscing elit.</h6>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4 col-xs-12">
            <div class="ce-feature-box-23">
              <div class="iconbox-tiny round white left icon"><span class="icon-map"></span></div>
              <div class="text-box-right less-padding-1">
                <h4 class="font-weight-6 text-white less-mar-1">Excellent <span class="gfs-didot">Support</span></h4>
                <h6 class="text-white">Consectetuer adipiscing elit.</h6>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="ce-feature-box-26">
              <h2 class="font-weight-6 less-mar-1 line-height-5">Popular Services <br/>
                Your successful </h2>
              <br/>
              <p>Praesent mattis commodo augue Aliquam ornare hendrerit augue Cras tellus In pulvinar lectus a est Curabitur eget orci Cras laoreet ligula Etiam.</p>
              <br/>
              <br/>
        ...
        <div class="row slider-btn-9">
          <div class="col-sm-12">
            <div class="sec-title-container text-center">
              ...
              <h6 class="ce-sub-text raleway opacity-5">Praesent mattis commodo augue Aliquam ornare hendrerit augue Cras tellus In pulvinar lectus a est Curabitur eget orci Cras laoreet ligula Etiam .</h6>
            </div>
          </div>
          <div class="clearfix"></div>
          <!--end title-->
          ...
          <div class="row">
            <div class="col-md-3">
              <div class="ce-feature-box-4">
                <div class="img"><img src="images/9.jpg" alt="" class="img-responsive"/></div>
                <div class="clearfix"></div>
                <br/>
                <h4 class="title">Fully Responsive</h4>
                <p class="small-text">Suspendisse et justo. Praesent mattis commodo augue Aliquam ornare hendrerit augue Cras tellus In pulvinar lectus a est Curabitur eget orci. </p>
                <div class="clearfix"></div>
                <br/>
                <br/>
                <a class="btn btn-white btn-medium btn-round uppercase" href="#"> Read more <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a> </div>
            </div>
            <!--end item-->
            
            <div class="col-md-3">
              <div class="ce-feature-box-4">
                <div class="img"><img src="images/10.jpg" alt="" class="img-responsive"/></div>
                <div class="clearfix"></div>
                <br/>
                <h4 class="title">Iconography</h4>
                <p class="small-text">Suspendisse et justo. Praesent mattis commodo augue Aliquam ornare hendrerit augue Cras tellus In pulvinar lectus a est Curabitur eget orci. </p>
                <div class="clearfix"></div>
                <br/>
                <br/>
            ...
            <div class="col-md-3">
              <div class="ce-feature-box-4">
                <div class="img"><img src="images/11.jpg" alt="" class="img-responsive"/></div>
                <div class="clearfix"></div>
                <br/>
                <h4 class="title">Success Tool</h4>
                <p class="small-text">Suspendisse et justo. Praesent mattis commodo augue Aliquam ornare hendrerit augue Cras tellus In pulvinar lectus a est Curabitur eget orci. </p>
                <div class="clearfix"></div>
                <br/>
                <br/>
            ...
            <div class="col-md-3">
              <div class="ce-feature-box-4">
                <div class="img"><img src="images/12.jpg" alt="" class="img-responsive"/></div>
                <div class="clearfix"></div>
                <br/>
                <h4 class="title">Lyered PSD</h4>
                <p class="small-text">Suspendisse et justo. Praesent mattis commodo augue Aliquam ornare hendrerit augue Cras tellus In pulvinar lectus a est Curabitur eget orci. </p>
                <div class="clearfix"></div>
                <br/>
                <br/>
   ...
   <section class="sec-padding section-light section-bgimg-6">
          ...
          <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="ce-feature-box-42 margin-bottom">
              ...
              <div class="text-box padding-4 white">
                ...
                <br/>
                <p>Praesent mattis commodo augue Aliquam ornare hendrerit augue Cras tellus In pulvinar lectus a est dolor sit amet.</p>
                <br/>
                <div class="line"></div>
                <div class="col-md-12 nopadding">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            <h2 class="less-mar-1 font-weight-3">Interested in working with Us?</h2>
            <div class="clearfix"></div>
            <br/>
            <a class="btn btn-border btn-border-1x btn-round uppercase" href="#"><i class="fa fa-play-circle" aria-hidden="true"></i> Contact Us</a> </div>
        </div>
      </div>
    </section>
    <div class="clearfix"></div>
    ...
    <div class="sec-padding section-primary">
      <div class="container">
        <div class="row">
          <div class="col-md-3 col-sm-12 colmargin clearfix margin-bottom">
            <div class="fo-map">
              <div class="footer-logo"><img src="images/logo/logo.png" alt=""/></div>
              <p class="text-white">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Suspendisse et justo. Praesent mattis commodo </p>
              <p class="text-white">consectetuer adipiscing elit Suspendisse et justo Praesent mattis commodo.</p>
              <h6 class="text-white">© -codelayers.net</h6>
            </div>
          </div>
          <!--end item-->
          
          <div class="col-md-3 col-xs-12 clearfix margin-bottom">
            <h4 class="less-mar3 font-weight-5 text-white">About Us</h4>
            <div class="clearfix"></div>
            <br/>
            <ul class="footer-quick-links-6 white">
              <li><a href="#"> Home</a></li>
          ...
          <div class="col-md-3 col-xs-12 clearfix margin-bottom">
            <h4 class="less-mar3 font-weight-5 text-white">Our Services</h4>
            <div class="clearfix"></div>
            <br/>
            <ul class="footer-quick-links-6">
              <li><a href="#"> UI Design</a></li>
              <li><a href="#"> Animations</a></li>
              <li><a href="#"> Graphic Design</a></li>
              <li><a href="#"> Responsive Design</a></li>
              <li><a href="#"> Phot Gallery</a></li>
            </ul>
          </div>
          <!--end item-->
          
          <div class="col-md-3 col-xs-12 clearfix margin-bottom">
            <h4 class="less-mar3 font-weight-5 text-white">Contact Us</h4>
            <div class="clearfix"></div>
            <br/>
            <address class="text-white">
            <strong class="text-white uppercase">Address:</strong> <br>
            No.28 - 63739 street lorem ipsum, <br>
            ipsum City, Country
            </address>
            <span class="text-white"><strong class="text-white uppercase">Phone:</strong> + 1 (234) 567 8901</span><br>
            <span class="text-white"><strong class="text-white uppercase">Email:</strong> email@example.com </span><br>
            <span class="text-white"><strong class="text-white uppercase">Fax:</strong> + 1 (234) 567 8901</span>
    ...
    <section class="sec-padding-6 section-primary">
      <div class="container">
        <div class="row">
          <div class="fo-copyright-holder text-center"> <span class="text-white">Copyright © 2019 <a href="https://1.envato.market/codelayers">Codelayers</a> | All rights reserved.</span> </div>
        </div>
      </div>
    </section>
    <div class="clearfix"></div>
...
<script src="js/revolution-slider/slider-custom-5.js"></script>
